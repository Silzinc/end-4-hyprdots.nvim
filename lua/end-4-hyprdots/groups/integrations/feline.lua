...
local C = require("end-4-hyprdots.palettes").get_palette()
...
if require("end-4-hyprdots").flavour == "light" then
	local light = require("end-4-hyprdots.palettes").get_palette "light"
	sett.text = light.base
	sett.bkg = light.crust
end

if require("end-4-hyprdots").options.transparent_background then sett.bkg = "NONE" end
