...
function M.get()
	return {
		...
		CursorLine = {
			bg = U.vary_color({ light = U.lighten(C.mantle, 0.70, C.base) }, U.darken(C.surface0, 0.64, C.base)),
		...
		Substitute = { bg = C.surface1, fg = U.vary_color({ light = C.red }, C.pink) }, -- |:substitute| replacement text highlighting
